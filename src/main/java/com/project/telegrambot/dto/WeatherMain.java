...
public class WeatherMain {
    ...
    public void setACCU_WEATHER_LOCATION_KEY(String ACCU_WEATHER_LOCATION_KEY) {
        this.ACCU_WEATHER_LOCATION_KEY = ACCU_WEATHER_LOCATION_KEY;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (this$ACCU_WEATHER_URL_DAILY == null ? other$ACCU_WEATHER_URL_DAILY != null : !this$ACCU_WEATHER_URL_DAILY.equals(other$ACCU_WEATHER_URL_DAILY))
            return false;
        final Object this$ACCU_WEATHER_LOCATION_KEY = this.getACCU_WEATHER_LOCATION_KEY();
        final Object other$ACCU_WEATHER_LOCATION_KEY = other.getACCU_WEATHER_LOCATION_KEY();
        if (this$ACCU_WEATHER_LOCATION_KEY == null ? other$ACCU_WEATHER_LOCATION_KEY != null : !this$ACCU_WEATHER_LOCATION_KEY.equals(other$ACCU_WEATHER_LOCATION_KEY))
            return false;
    ...
    public int hashCode() {
        ...
        final Object $ACCU_WEATHER_LOCATION_KEY = this.getACCU_WEATHER_LOCATION_KEY();
        result = result * PRIME + ($ACCU_WEATHER_LOCATION_KEY == null ? 43 : $ACCU_WEATHER_LOCATION_KEY.hashCode());
    ...
    public String toString() {
        return "WeatherMain(ACCU_WEATHER_URL_NOW=" + this.getACCU_WEATHER_URL_NOW() + ", ACCU_WEATHER_API_KEY=" + this.getACCU_WEATHER_API_KEY() + ", ACCU_WEATHER_URL_DAILY=" + this.getACCU_WEATHER_URL_DAILY() + ", ACCU_WEATHER_LOCATION_KEY=" + this.getACCU_WEATHER_LOCATION_KEY() + ", ACCU_WEATHER_LOCATION_URL=" + this.getACCU_WEATHER_LOCATION_URL() + ")";
    }
}
